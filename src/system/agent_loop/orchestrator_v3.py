...
from .agents.ontology_construction.axiom_extraction_agent import AxiomExtractionAgent
from .agents.ontology_construction.instance_extraction_agent import InstanceExtractionAgent
#from .agents.ontology_construction.instance_extraction_agent2 import InstanceExtractionAgent2
import logging
