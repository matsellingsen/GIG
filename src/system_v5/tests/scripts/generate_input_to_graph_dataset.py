...
domains = {
    "biology": {
        ...
        "taxonomic": {
            ...
            "list": [
                ("What is an Animal a subtype of?", "List the superclasses of Animal.", "Name every single category that Animal is a subtype of."),
...
out_path = Path("c:/Users/matse/gig/src/system_v5/tests/dataset/new_synthetic_labelled_input.json")
